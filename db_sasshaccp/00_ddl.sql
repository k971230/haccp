...
--    4) _yn varchar(1) 칸의 Y/N CHECK 31본은 이 파일이 아니라 00_alter.sql 끝에 한 덩이로 있다.
--       00_alter 는 빈 DB·이미 깐 DB 양쪽에서 항상 돌아서 거기 한 곳이면 전부 걸린다.
--       여기 인라인으로 또 적으면 표 22개에 흩어져 둘이 갈린다 — 짝은 그 한 곳에서 늘린다.
--       (tbl_html_*_ver 6표의 12본은 옛날부터 인라인이라 그대로 둔다)
--    5) 표·컬럼 COMMENT 는 파일 맨 아래 주석 블록(마커 한 쌍)에만 둔다.
--       apply-all 은 00_alter·01_sp 다음에 그 블록만 다시 적용한다. 00_alter 에 복제하지 않는다.
--
...
CREATE TABLE sasshaccp.tbl_company_template_file (
    ...
    default_yn character varying(1) DEFAULT 'N'::character varying NOT NULL,
    current_yn character varying(1) DEFAULT 'N'::character varying NOT NULL,
    ins_id character varying(20),
    ins_dt timestamp without time zone DEFAULT now()
);
...
ALTER TABLE ONLY sasshaccp.tbl_check_item
    ADD CONSTRAINT ux_tbl_check_item UNIQUE (co_cd, tmpl_cd, item_cd);
...
ALTER TABLE sasshaccp.tbl_audit_log
    ADD COLUMN IF NOT EXISTS scrn_cd character varying(30);
...
ALTER TABLE sasshaccp.tbl_approval_line
    ADD CONSTRAINT fk_tbl_approval_line_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_approval_line_step
    ADD CONSTRAINT fk_tbl_approval_line_step_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_audit_log
    ADD CONSTRAINT fk_tbl_audit_log_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_htg_monitor
    ADD CONSTRAINT fk_tbl_ccp_htg_monitor_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_htg_monitor_cell
    ADD CONSTRAINT fk_tbl_ccp_htg_monitor_cell_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_htg_monitor_row
    ADD CONSTRAINT fk_tbl_ccp_htg_monitor_row_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_pkg_monitor
    ADD CONSTRAINT fk_tbl_ccp_pkg_monitor_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_pkg_monitor_cell
    ADD CONSTRAINT fk_tbl_ccp_pkg_monitor_cell_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_pkg_monitor_row
    ADD CONSTRAINT fk_tbl_ccp_pkg_monitor_row_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_metal_monitor
    ADD CONSTRAINT fk_tbl_ccp_metal_monitor_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_metal_pass_row
    ADD CONSTRAINT fk_tbl_ccp_metal_pass_row_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_metal_sens_row
    ADD CONSTRAINT fk_tbl_ccp_metal_sens_row_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_verify_check
    ADD CONSTRAINT fk_tbl_ccp_verify_check_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_ccp_verify_item
    ADD CONSTRAINT fk_tbl_ccp_verify_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_check_item
    ADD CONSTRAINT fk_tbl_check_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_code
    ADD CONSTRAINT fk_tbl_code_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_company_template
    ADD CONSTRAINT fk_tbl_company_template_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_company_template_file
    ADD CONSTRAINT fk_tbl_company_template_file_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_corrective_action
    ADD CONSTRAINT fk_tbl_corrective_action_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_dept
    ADD CONSTRAINT fk_tbl_dept_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_doc_no_rule
    ADD CONSTRAINT fk_tbl_doc_no_rule_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_document
    ADD CONSTRAINT fk_tbl_document_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_document_approval
    ADD CONSTRAINT fk_tbl_document_approval_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_document_file
    ADD CONSTRAINT fk_tbl_document_file_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_document_version
    ADD CONSTRAINT fk_tbl_document_version_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_grid_pref
    ADD CONSTRAINT fk_tbl_grid_pref_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_form_ver
    ADD CONSTRAINT fk_tbl_html_form_ver_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_form_ver_item
    ADD CONSTRAINT fk_tbl_html_form_ver_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_hyg_prc_ver
    ADD CONSTRAINT fk_tbl_html_hyg_prc_ver_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_hyg_prc_ver_item
    ADD CONSTRAINT fk_tbl_html_hyg_prc_ver_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_hyg_process
    ADD CONSTRAINT fk_tbl_hyg_process_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_hyg_process_item
    ADD CONSTRAINT fk_tbl_hyg_process_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_login_log
    ADD CONSTRAINT fk_tbl_login_log_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_menu
    ADD CONSTRAINT fk_tbl_menu_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_notification
    ADD CONSTRAINT fk_tbl_notification_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_role
    ADD CONSTRAINT fk_tbl_role_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_role_screen
    ADD CONSTRAINT fk_tbl_role_screen_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_schedule_rule
    ADD CONSTRAINT fk_tbl_schedule_rule_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_schedule_rule_detail
    ADD CONSTRAINT fk_tbl_schedule_rule_detail_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_schedule_task
    ADD CONSTRAINT fk_tbl_schedule_task_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_screen
    ADD CONSTRAINT fk_tbl_screen_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_template
    ADD CONSTRAINT fk_tbl_template_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_chk_ver
    ADD CONSTRAINT fk_tbl_html_ccp_chk_ver_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_chk_ver_item
    ADD CONSTRAINT fk_tbl_html_ccp_chk_ver_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_htg_ver
    ADD CONSTRAINT fk_tbl_html_ccp_htg_ver_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_htg_ver_item
    ADD CONSTRAINT fk_tbl_html_ccp_htg_ver_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_mtl_ver
    ADD CONSTRAINT fk_tbl_html_ccp_mtl_ver_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_mtl_ver_item
    ADD CONSTRAINT fk_tbl_html_ccp_mtl_ver_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_pkg_ver
    ADD CONSTRAINT fk_tbl_html_ccp_pkg_ver_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_pkg_ver_item
    ADD CONSTRAINT fk_tbl_html_ccp_pkg_ver_item_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_user
    ADD CONSTRAINT fk_tbl_user_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_user_noti_pref
    ADD CONSTRAINT fk_tbl_user_noti_pref_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_view_log
    ADD CONSTRAINT fk_tbl_view_log_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);

ALTER TABLE sasshaccp.tbl_view_stat_daily
    ADD CONSTRAINT fk_tbl_view_stat_daily_co_cd FOREIGN KEY (co_cd) REFERENCES sasshaccp.tbl_company(co_cd);
...
ALTER TABLE sasshaccp.tbl_role_screen
    ADD CONSTRAINT fk_tbl_role_screen_scrn FOREIGN KEY (scrn_cd) REFERENCES sasshaccp.tbl_screen(scrn_cd);

ALTER TABLE sasshaccp.tbl_template
    ADD CONSTRAINT fk_tbl_template_scrn FOREIGN KEY (scrn_cd) REFERENCES sasshaccp.tbl_screen(scrn_cd);

ALTER TABLE sasshaccp.tbl_grid_pref
    ADD CONSTRAINT fk_tbl_grid_pref_scrn FOREIGN KEY (scrn_cd) REFERENCES sasshaccp.tbl_screen(scrn_cd);

ALTER TABLE sasshaccp.tbl_audit_log
    ADD CONSTRAINT fk_tbl_audit_log_scrn FOREIGN KEY (scrn_cd) REFERENCES sasshaccp.tbl_screen(scrn_cd);

ALTER TABLE sasshaccp.tbl_view_log
    ADD CONSTRAINT fk_tbl_view_log_scrn FOREIGN KEY (scrn_cd) REFERENCES sasshaccp.tbl_screen(scrn_cd);

ALTER TABLE sasshaccp.tbl_view_stat_daily
    ADD CONSTRAINT fk_tbl_view_stat_daily_scrn FOREIGN KEY (scrn_cd) REFERENCES sasshaccp.tbl_screen(scrn_cd);

ALTER TABLE sasshaccp.tbl_notification
    ADD CONSTRAINT fk_tbl_notification_scrn FOREIGN KEY (link_scrn_cd) REFERENCES sasshaccp.tbl_screen(scrn_cd);

ALTER TABLE sasshaccp.tbl_check_item
    ADD CONSTRAINT fk_tbl_check_item_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_company_template
    ADD CONSTRAINT fk_tbl_company_template_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_company_template_file
    ADD CONSTRAINT fk_tbl_company_template_file_ct FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_company_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_doc_no_rule
    ADD CONSTRAINT fk_tbl_doc_no_rule_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_document
    ADD CONSTRAINT fk_tbl_document_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_schedule_rule
    ADD CONSTRAINT fk_tbl_schedule_rule_ct FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_company_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_schedule_task
    ADD CONSTRAINT fk_tbl_schedule_task_ct FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_company_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_html_form_ver
    ADD CONSTRAINT fk_tbl_html_form_ver_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_html_hyg_prc_ver
    ADD CONSTRAINT fk_tbl_html_hyg_prc_ver_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_chk_ver
    ADD CONSTRAINT fk_tbl_html_ccp_chk_ver_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_htg_ver
    ADD CONSTRAINT fk_tbl_html_ccp_htg_ver_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_mtl_ver
    ADD CONSTRAINT fk_tbl_html_ccp_mtl_ver_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_html_ccp_pkg_ver
    ADD CONSTRAINT fk_tbl_html_ccp_pkg_ver_tmpl FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_template(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_html_form_ver_item
    ADD CONSTRAINT fk_tbl_html_form_ver_item_ver FOREIGN KEY (co_cd, tmpl_cd, ver_no) REFERENCES sasshaccp.tbl_html_form_ver(co_cd, tmpl_cd, ver_no);

ALTER TABLE sasshaccp.tbl_html_hyg_prc_ver_item
    ADD CONSTRAINT fk_tbl_html_hyg_prc_ver_item_ver FOREIGN KEY (co_cd, tmpl_cd, ver_no) REFERENCES sasshaccp.tbl_html_hyg_prc_ver(co_cd, tmpl_cd, ver_no);

ALTER TABLE sasshaccp.tbl_html_ccp_chk_ver_item
    ADD CONSTRAINT fk_tbl_html_ccp_chk_ver_item_ver FOREIGN KEY (co_cd, tmpl_cd, ver_no) REFERENCES sasshaccp.tbl_html_ccp_chk_ver(co_cd, tmpl_cd, ver_no);

ALTER TABLE sasshaccp.tbl_html_ccp_htg_ver_item
    ADD CONSTRAINT fk_tbl_html_ccp_htg_ver_item_ver FOREIGN KEY (co_cd, tmpl_cd, ver_no) REFERENCES sasshaccp.tbl_html_ccp_htg_ver(co_cd, tmpl_cd, ver_no);

ALTER TABLE sasshaccp.tbl_html_ccp_mtl_ver_item
    ADD CONSTRAINT fk_tbl_html_ccp_mtl_ver_item_ver FOREIGN KEY (co_cd, tmpl_cd, ver_no) REFERENCES sasshaccp.tbl_html_ccp_mtl_ver(co_cd, tmpl_cd, ver_no);

ALTER TABLE sasshaccp.tbl_html_ccp_pkg_ver_item
    ADD CONSTRAINT fk_tbl_html_ccp_pkg_ver_item_ver FOREIGN KEY (co_cd, tmpl_cd, ver_no) REFERENCES sasshaccp.tbl_html_ccp_pkg_ver(co_cd, tmpl_cd, ver_no);

ALTER TABLE sasshaccp.tbl_approval_line_step
    ADD CONSTRAINT fk_tbl_approval_line_step_line FOREIGN KEY (co_cd, appr_line_cd) REFERENCES sasshaccp.tbl_approval_line(co_cd, appr_line_cd);

ALTER TABLE sasshaccp.tbl_company_template
    ADD CONSTRAINT fk_tbl_company_template_line FOREIGN KEY (co_cd, appr_line_cd) REFERENCES sasshaccp.tbl_approval_line(co_cd, appr_line_cd);

ALTER TABLE sasshaccp.tbl_document
    ADD CONSTRAINT fk_tbl_document_line FOREIGN KEY (co_cd, appr_line_cd) REFERENCES sasshaccp.tbl_approval_line(co_cd, appr_line_cd);

ALTER TABLE sasshaccp.tbl_role_screen
    ADD CONSTRAINT fk_tbl_role_screen_role FOREIGN KEY (co_cd, usrgrp_cd) REFERENCES sasshaccp.tbl_role(co_cd, usrgrp_cd);

ALTER TABLE sasshaccp.tbl_user
    ADD CONSTRAINT fk_tbl_user_role FOREIGN KEY (co_cd, usrgrp_cd) REFERENCES sasshaccp.tbl_role(co_cd, usrgrp_cd);

ALTER TABLE sasshaccp.tbl_user
    ADD CONSTRAINT fk_tbl_user_dept FOREIGN KEY (co_cd, dept_cd) REFERENCES sasshaccp.tbl_dept(co_cd, dept_cd);

ALTER TABLE sasshaccp.tbl_schedule_task
    ADD CONSTRAINT fk_tbl_schedule_task_dept FOREIGN KEY (co_cd, dept_cd) REFERENCES sasshaccp.tbl_dept(co_cd, dept_cd);

ALTER TABLE sasshaccp.tbl_grid_pref
    ADD CONSTRAINT fk_tbl_grid_pref_user FOREIGN KEY (user_id) REFERENCES sasshaccp.tbl_user(user_id);

ALTER TABLE sasshaccp.tbl_user_noti_pref
    ADD CONSTRAINT fk_tbl_user_noti_pref_user FOREIGN KEY (user_id) REFERENCES sasshaccp.tbl_user(user_id);

ALTER TABLE sasshaccp.tbl_notification
    ADD CONSTRAINT fk_tbl_notification_user FOREIGN KEY (user_id) REFERENCES sasshaccp.tbl_user(user_id);

ALTER TABLE sasshaccp.tbl_schedule_rule_detail
    ADD CONSTRAINT fk_tbl_schedule_rule_detail_rule FOREIGN KEY (co_cd, tmpl_cd) REFERENCES sasshaccp.tbl_schedule_rule(co_cd, tmpl_cd);

ALTER TABLE sasshaccp.tbl_document_approval
    ADD CONSTRAINT fk_tbl_document_approval_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_document_file
    ADD CONSTRAINT fk_tbl_document_file_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_document_version
    ADD CONSTRAINT fk_tbl_document_version_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_hyg_process
    ADD CONSTRAINT fk_tbl_hyg_process_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_ccp_verify_check
    ADD CONSTRAINT fk_tbl_ccp_verify_check_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_ccp_pkg_monitor
    ADD CONSTRAINT fk_tbl_ccp_pkg_monitor_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_ccp_htg_monitor
    ADD CONSTRAINT fk_tbl_ccp_htg_monitor_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_ccp_metal_monitor
    ADD CONSTRAINT fk_tbl_ccp_metal_monitor_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_schedule_task
    ADD CONSTRAINT fk_tbl_schedule_task_doc FOREIGN KEY (doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_notification
    ADD CONSTRAINT fk_tbl_notification_doc FOREIGN KEY (link_doc_idx) REFERENCES sasshaccp.tbl_document(idx);

ALTER TABLE sasshaccp.tbl_hyg_process_item
    ADD CONSTRAINT fk_tbl_hyg_process_item_hdr FOREIGN KEY (hdr_idx) REFERENCES sasshaccp.tbl_hyg_process(idx);

ALTER TABLE sasshaccp.tbl_ccp_verify_item
    ADD CONSTRAINT fk_tbl_ccp_verify_item_hdr FOREIGN KEY (hdr_idx) REFERENCES sasshaccp.tbl_ccp_verify_check(idx);

ALTER TABLE sasshaccp.tbl_ccp_metal_sens_row
    ADD CONSTRAINT fk_tbl_ccp_metal_sens_row_hdr FOREIGN KEY (hdr_idx) REFERENCES sasshaccp.tbl_ccp_metal_monitor(idx);

ALTER TABLE sasshaccp.tbl_ccp_metal_pass_row
    ADD CONSTRAINT fk_tbl_ccp_metal_pass_row_hdr FOREIGN KEY (hdr_idx) REFERENCES sasshaccp.tbl_ccp_metal_monitor(idx);

ALTER TABLE sasshaccp.tbl_ccp_pkg_monitor_row
    ADD CONSTRAINT fk_tbl_ccp_pkg_monitor_row_mon FOREIGN KEY (monitor_idx) REFERENCES sasshaccp.tbl_ccp_pkg_monitor(idx);

ALTER TABLE sasshaccp.tbl_ccp_htg_monitor_row
    ADD CONSTRAINT fk_tbl_ccp_htg_monitor_row_mon FOREIGN KEY (monitor_idx) REFERENCES sasshaccp.tbl_ccp_htg_monitor(idx);

ALTER TABLE sasshaccp.tbl_ccp_pkg_monitor_cell
    ADD CONSTRAINT fk_tbl_ccp_pkg_monitor_cell_row FOREIGN KEY (row_idx) REFERENCES sasshaccp.tbl_ccp_pkg_monitor_row(idx);

ALTER TABLE sasshaccp.tbl_ccp_htg_monitor_cell
    ADD CONSTRAINT fk_tbl_ccp_htg_monitor_cell_row FOREIGN KEY (row_idx) REFERENCES sasshaccp.tbl_ccp_htg_monitor_row(idx);
...
-- =================================================================
-- START_COMMENT_BLOCK
-- apply-all.sh 가 이 두 마커 사이를 통째로 psql 에 넣는다. 여기 밖 COMMENT ON 금지.
-- =================================================================
...
COMMENT ON COLUMN sasshaccp.tbl_screen.co_cd IS '회사코드 — 플랫폼 카탈로그는 0000. 화면코드(scrn_cd)는 전역 유일';
...
COMMENT ON COLUMN sasshaccp.tbl_company_template.co_form_idx IS '활성 자사 양식 idx — base_use_yn=N일 때 회사 HTML 버전(tbl_html_*_ver.idx)';
...
COMMENT ON COLUMN sasshaccp.tbl_company_template_file.idx IS 'PK 자동 채번 대리키';
...
COMMENT ON COLUMN sasshaccp.tbl_company_template_file.default_yn IS '기본 제공 파일 Y/N — 양식당 살아 있는 행 하나. 초기화 대상';
COMMENT ON COLUMN sasshaccp.tbl_company_template_file.current_yn IS '현재 적용 파일 Y/N — 양식당 살아 있는 행 하나. 업로드·불러오기로만 바뀐다';
...
COMMENT ON COLUMN sasshaccp.tbl_check_item.co_cd IS '회사코드 — 테넌트 키. 플랫폼 표준 항목은 0000';
...
COMMENT ON TABLE sasshaccp.tbl_html_form_ver IS 'HTML 양식 버전 — 업체가 고른 적용본. 표준 가상행(ver_no=0)은 두지 않는다';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.idx IS '대리키 PK — identity';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.ver_no IS '표시 순번 — 1부터. 항목·작성 문서가 참조하므로 재사용 금지';
...
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.upd_dt IS '최종수정일시';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.use_yn IS '사용여부 — N=소프트 삭제';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver.ver_cd IS '버전코드 — 활성(use_yn=Y)만 업체+양식당 유니크. 삭제 후 재사용 가능';

COMMENT ON TABLE sasshaccp.tbl_html_form_ver_item IS 'HTML 양식 버전 항목 — 부모(tbl_html_form_ver)와 (co_cd, tmpl_cd, ver_no)로 묶인다';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.ver_no IS '부모 버전 순번 — tbl_html_form_ver.ver_no';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.item_cd IS '항목코드 — 템플릿 내 유일';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.sort_no IS '정렬순서';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.cycle_nm IS '점검주기 — 1회/일 등. 방법 열과 함께 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.grp_nm IS '항목 구분명 — A4 표 좌측 병합 셀에 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.item_nm IS '점검항목 문구 — 표준기준서 원문';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.input_type IS 'html-input-ty — radio / radio-num / radio-text / num / text';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.unit_nm IS '단위 — 숫자 입력 항목 표시용';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_form_ver_item.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_hyg_prc_ver IS '일반위생·공정점검 자사 양식 버전 — 예시는 html_hyg_prc_000 가상';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.ver_no IS '표시 순번 — 1부터. 항목·작성 문서가 참조하므로 재사용 금지';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.ver_cd IS '버전코드 — 활성(use_yn=Y)만 업체+양식당 유니크. 삭제 후 재사용 가능';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.ver_nm IS '버전명 — 유니크 아님';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.apply_yn IS '작성 신규 적용. 없으면(전부 N) 표준';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.use_yn IS '사용여부 Y/N';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_hyg_prc_ver_item IS '일반위생·공정점검 자사 양식 항목';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.ver_no IS '부모 버전 순번 — tbl_html_hyg_prc_ver.ver_no';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.item_cd IS '항목코드 — 템플릿 내 유일';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.sort_no IS '정렬순서';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.cycle_nm IS '점검주기 — 1회/일 등. 방법 열과 함께 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.grp_nm IS '항목 구분명 — A4 표 좌측 병합 셀에 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.item_nm IS '점검항목 문구 — 표준기준서 원문';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.input_type IS 'html-input-ty — radio / radio-num / radio-text / num / text';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.unit_nm IS '단위 — 숫자 입력 항목 표시용';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_hyg_prc_ver_item.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_ccp_chk_ver IS 'CCP 검증점검 자사 양식 버전 — 예시는 html_ccp_chk_000 가상';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.ver_no IS '표시 순번 — 1부터. 항목·작성 문서가 참조하므로 재사용 금지';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.ver_cd IS '버전코드 — 활성(use_yn=Y)만 업체+양식당 유니크. 삭제 후 재사용 가능';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.ver_nm IS '버전명 — 유니크 아님';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.apply_yn IS '작성 신규 적용. 없으면(전부 N) 표준';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.use_yn IS '사용여부 Y/N';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_ccp_chk_ver_item IS 'CCP 검증점검 자사 양식 항목';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.ver_no IS '부모 버전 순번 — tbl_html_ccp_chk_ver.ver_no';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.item_cd IS '항목코드 — 템플릿 내 유일';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.sort_no IS '정렬순서';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.cycle_nm IS '점검주기 — 1회/일 등. 방법 열과 함께 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.grp_nm IS '항목 구분명 — A4 표 좌측 병합 셀에 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.item_nm IS '점검항목 문구 — 표준기준서 원문';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.input_type IS 'html-input-ty — radio / radio-num / radio-text / num / text';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.unit_nm IS '단위 — 숫자 입력 항목 표시용';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_chk_ver_item.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_ccp_pkg_ver IS 'CCP-1B 포장 모니터링일지 자사 양식 버전 — 예시는 html_ccp_pkg_000 가상';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.ver_no IS '표시 순번 — 1부터. 항목·작성 문서가 참조하므로 재사용 금지';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.ver_cd IS '버전코드 — 활성(use_yn=Y)만 업체+양식당 유니크. 삭제 후 재사용 가능';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.ver_nm IS '버전명 — 유니크 아님';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.apply_yn IS '작성 신규 적용. 없으면(전부 N) 표준';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.use_yn IS '사용여부 Y/N';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_ccp_pkg_ver_item IS 'CCP-1B 포장 모니터링일지 자사 양식 항목 — 한계기준·주기·방법·개선조치';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.ver_no IS '부모 버전 순번 — tbl_html_ccp_pkg_ver.ver_no';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.item_cd IS '항목코드 — 템플릿 내 유일';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.sort_no IS '정렬순서';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.cycle_nm IS '점검주기 — 1회/일 등. 방법 열과 함께 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.grp_nm IS '항목 구분명 — A4 표 좌측 병합 셀에 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.item_nm IS '점검항목 문구 — 표준기준서 원문';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.input_type IS 'html-input-ty — radio / radio-num / radio-text / num / text';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.unit_nm IS '단위 — 숫자 입력 항목 표시용';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_pkg_ver_item.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_ccp_htg_ver IS 'CCP-2B 가열 모니터링일지 자사 양식 버전 — 예시는 html_ccp_htg_000 가상';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.ver_no IS '표시 순번 — 1부터. 항목·작성 문서가 참조하므로 재사용 금지';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.ver_cd IS '버전코드 — 활성(use_yn=Y)만 업체+양식당 유니크. 삭제 후 재사용 가능';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.ver_nm IS '버전명 — 유니크 아님';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.apply_yn IS '작성 신규 적용. 없으면(전부 N) 표준';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.use_yn IS '사용여부 Y/N';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_ccp_htg_ver_item IS 'CCP-2B 가열 모니터링일지 자사 양식 항목 — 한계기준·주기·방법·개선조치';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.ver_no IS '부모 버전 순번 — tbl_html_ccp_htg_ver.ver_no';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.item_cd IS '항목코드 — 템플릿 내 유일';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.sort_no IS '정렬순서';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.cycle_nm IS '점검주기 — 1회/일 등. 방법 열과 함께 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.grp_nm IS '항목 구분명 — A4 표 좌측 병합 셀에 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.item_nm IS '점검항목 문구 — 표준기준서 원문';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.input_type IS 'html-input-ty — radio / radio-num / radio-text / num / text';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.unit_nm IS '단위 — 숫자 입력 항목 표시용';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_htg_ver_item.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_ccp_mtl_ver IS 'CCP-3P 금속검출 모니터링일지 자사 양식 버전 — 예시는 html_ccp_mtl_000 가상';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.ver_no IS '표시 순번 — 1부터. 항목·작성 문서가 참조하므로 재사용 금지';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.ver_cd IS '버전코드 — 활성(use_yn=Y)만 업체+양식당 유니크. 삭제 후 재사용 가능';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.ver_nm IS '버전명 — 유니크 아님';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.apply_yn IS '작성 신규 적용. 없으면(전부 N) 표준';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.use_yn IS '사용여부 Y/N';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_html_ccp_mtl_ver_item IS 'CCP-3P 금속검출 모니터링일지 자사 양식 항목 — 한계기준·주기·방법·감도열 해당없음·개선조치';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.ver_no IS '부모 버전 순번 — tbl_html_ccp_mtl_ver.ver_no';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.item_cd IS '항목코드 — 템플릿 내 유일';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.sort_no IS '정렬순서';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.cycle_nm IS '점검주기 — 1회/일 등. 방법 열과 함께 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.grp_nm IS '항목 구분명 — A4 표 좌측 병합 셀에 출력';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.item_nm IS '점검항목 문구 — 표준기준서 원문';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.input_type IS 'html-input-ty — radio / radio-num / radio-text / num / text';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.unit_nm IS '단위 — 숫자 입력 항목 표시용';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_html_ccp_mtl_ver_item.upd_dt IS '최종수정일시';
...
COMMENT ON TABLE sasshaccp.tbl_hyg_process IS '일반위생·공정점검 작성 헤더 — 문서(tbl_document) 1:1';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.doc_idx IS '문서 idx — tbl_document.idx와 1:1';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.base_dt IS '점검일자 YYYYMMDD';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.checker_nm IS '점검자명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.ver_no IS '작성에 쓴 자사 양식 버전 — tbl_html_hyg_prc_ver.ver_no. 회사 버전이 없으면 NULL(표준 항목)';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.special_note IS '특이사항 — 개행 보존';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.improve_note IS '개선사항 — 개행 보존';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.action_nm IS '조치내용 — 개행 보존';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.confirm_nm IS '확인자명 스냅샷 — 지면 하단 확인칸';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.upd_dt IS '최종수정일시';
...
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.approver_id IS '결재자 로그인 ID';
...
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.confirm_id IS '확인자 로그인 ID';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process.confirm_sign_img IS '확인 서명 스냅샷 — 없으면 confirm_nm만';

COMMENT ON TABLE sasshaccp.tbl_hyg_process_item IS '일반위생·공정점검 작성 항목 — 헤더(tbl_hyg_process.idx)의 자식';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.hdr_idx IS '헤더 idx — tbl_hyg_process.idx';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.sort_no IS '정렬순서';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.item_cd IS '항목코드 — 템플릿 내 유일';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.cycle_nm IS '점검주기 — 1회/일 등. 방법 열과 함께 출력';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.grp_nm IS '항목 구분명 — A4 표 좌측 병합 셀에 출력';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.item_nm IS '점검항목 문구 — 표준기준서 원문';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.input_type IS 'html-input-ty — radio / radio-num / radio-text / num / text';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.unit_nm IS '단위 — 숫자 입력 항목 표시용';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.yn IS '판정값 — Y/N 또는 양호/불량 코드';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.val_nm IS '수치·서술 값 — input_type이 radio가 아닐 때';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_hyg_process_item.upd_dt IS '최종수정일시';
...
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.ver_no IS '작성에 쓴 자사 양식 버전 — tbl_html_ccp_chk_ver.ver_no. 회사 버전이 없으면 NULL(표준 항목)';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.checker_sign_img IS '점검자 서명 스냅샷 — 없으면 이름만';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.approver_id IS '결재자 로그인 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.approver_nm IS '승인자명 스냅샷 — 지면 결재란';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.approver_sign_img IS '승인자 서명 스냅샷 — 없으면 이름만';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.confirm_id IS '확인자 로그인 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.confirm_nm IS '확인자명 스냅샷 — 지면 하단 확인칸';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.confirm_sign_img IS '확인 서명 스냅샷 — 없으면 confirm_nm만';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.special_note IS '특이사항 — 개행 보존';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.improve_note IS '개선사항 — 개행 보존';
COMMENT ON COLUMN sasshaccp.tbl_ccp_verify_check.action_nm IS '조치내용 — 개행 보존';
...
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.doc_idx IS '문서 idx — tbl_document.idx와 1:1';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.base_dt IS '작성일 YYYYMMDD';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.ccp_cd IS 'CCP 코드 — 포장공정 식별';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.diary_no IS '일지번호 — 당일 포장 모니터링 식별';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.limit_item_kind IS '한계항목 프리셋 — 셀 item_cd 집합을 정한다';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.mng_user_id IS '담당자 로그인 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.mng_nm IS '담당자명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.form_src IS '작성 양식 출처 — BASE 또는 CUSTOM. 과거 양식 이력 보존';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.co_form_idx IS '작성 시점 자사 양식 idx — CUSTOM일 때만 값 보관';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_ccp_pkg_monitor_row IS 'CCP 포장 점검 행 — 시간별 측정·판정·점검자';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.monitor_idx IS '헤더 idx — tbl_ccp_pkg_monitor.idx';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.row_seq IS '행 순번';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.check_time IS '점검시간 HHMM';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.judge_cd IS '행 판정 — P:적합, F:부적합';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.judge_mod_yn IS '판정 수동변경 여부 Y/N';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.checker_id IS '점검자 로그인 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.checker_nm IS '점검자명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.upd_dt IS '최종수정일시';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.equip_nm IS '설비명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.product_nm IS '품명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_row.phase_cd IS '점검 시점 — BEFORE:작업 전, DURING:작업 중, AFTER:작업 후';
...
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.row_idx IS '행 idx — tbl_ccp_pkg_monitor_row.idx';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.item_cd IS '한계항목 코드 — limit_item_kind 프리셋의 열 식별자';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.num_val IS '수치 측정값 — 한계항목이 숫자일 때';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.txt_val IS '텍스트 측정값 — 한계항목이 서술일 때';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.judge_cd IS '항목 판정 — P:적합, F:부적합';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_pkg_monitor_cell.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_ccp_htg_monitor IS 'CCP 가열 모니터링 헤더 — 표준기준서 가열공정 기록';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.doc_idx IS '문서 idx — tbl_document.idx와 1:1';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.base_dt IS '작성일 YYYYMMDD';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.tmpl_cd IS '템플릿 코드 — tbl_template.tmpl_cd';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.ccp_cd IS 'CCP 코드 — 가열공정 식별';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.diary_no IS '일지번호 — 당일 가열 모니터링 식별';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.limit_item_kind IS '한계항목 프리셋 — 셀 item_cd 집합을 정한다';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.mng_user_id IS '담당자 로그인 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.mng_nm IS '담당자명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.form_src IS '작성 양식 출처 — BASE 또는 CUSTOM. 과거 양식 이력 보존';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.co_form_idx IS '작성 시점 자사 양식 idx — CUSTOM일 때만 값 보관';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor.upd_dt IS '최종수정일시';

COMMENT ON TABLE sasshaccp.tbl_ccp_htg_monitor_row IS 'CCP 가열 점검 행 — 시간별 측정·판정·점검자';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.monitor_idx IS '헤더 idx — tbl_ccp_htg_monitor.idx';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.row_seq IS '행 순번';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.check_time IS '점검시간 HHMM';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.judge_cd IS '행 판정 — P:적합, F:부적합';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.judge_mod_yn IS '판정 수동변경 여부 Y/N';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.checker_id IS '점검자 로그인 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.checker_nm IS '점검자명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.upd_dt IS '최종수정일시';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.equip_nm IS '설비명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.product_nm IS '품명 — 작성 시점 스냅샷';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_row.phase_cd IS '점검 시점 — BEFORE:작업 전, DURING:작업 중, AFTER:작업 후';
...
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.idx IS 'PK 자동 채번 대리키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.co_cd IS '회사코드 — 테넌트 키';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.row_idx IS '행 idx — tbl_ccp_htg_monitor_row.idx';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.item_cd IS '한계항목 코드 — limit_item_kind 프리셋의 열 식별자';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.num_val IS '수치 측정값 — 한계항목이 숫자일 때';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.txt_val IS '텍스트 측정값 — 한계항목이 서술일 때';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.judge_cd IS '항목 판정 — P:적합, F:부적합';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.ins_id IS '최초입력자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.ins_dt IS '최초입력일시';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.upd_id IS '최종수정자 ID';
COMMENT ON COLUMN sasshaccp.tbl_ccp_htg_monitor_cell.upd_dt IS '최종수정일시';
...
COMMENT ON COLUMN sasshaccp.tbl_ccp_metal_monitor.ccp_cd IS 'CCP 코드 — 금속검출 공정 식별';
...
COMMENT ON COLUMN sasshaccp.tbl_ccp_metal_sens_row.product_cd IS '품목코드 — 작성 시점 스냅샷';
...
COMMENT ON COLUMN sasshaccp.tbl_ccp_metal_pass_row.product_cd IS '품목코드 — 작성 시점 스냅샷';
