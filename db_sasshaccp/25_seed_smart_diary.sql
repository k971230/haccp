...
INSERT INTO tbl_template (
    ...
    ('CCP_HEAT',     '가열 모니터링 일지',         'DB', 'CCP', 'ccp-heat-monitor', 'D', 24, 'Y', 31, 'system'),
    ('CCP_WASH',     '세척 모니터링 일지',         'DB', 'CCP', 'ccp-wash-monitor', 'D', 24, 'Y', 32, 'system'),
    ('CCP_SANITIZE', '멸균 모니터링 일지',         'DB', 'CCP', 'ccp-sanitize-monitor', 'D', 24, 'Y', 33, 'system'),
    ('CCP_FILTER',   '여과 모니터링 일지',         'DB', 'CCP', 'ccp-filter-monitor', 'D', 24, 'Y', 34, 'system'),
    ...
    ('RECALL',       '회수관리',                   'HWP','DOC', NULL, 'E', 36, 'Y', 57, 'system'),
    ('EMERGENCY',    '비상관리계획',               'HWP','DOC', NULL, 'Y', 36, 'Y', 58, 'system'),
    ('LAW_HEALTH',   '보건증관리',                 'HWP','LAW', 'law-health-cert', 'E', 36, 'Y', 61, 'system'),
    ('LAW_MATERIAL', '원료수불대장관리',           'HWP','LAW', 'law-material-ledger', 'M', 36, 'Y', 62, 'system'),
    ('LAW_BUILDING', '건축물대장관리',             'HWP','LAW', 'law-building-ledger', 'E', 36, 'Y', 63, 'system'),
    ('LAW_PRODUCTION','생산대장관리',              'HWP','LAW', 'law-production-ledger', 'D', 36, 'Y', 64, 'system'),
    ('LAW_LICENSE',  '영업등록증관리',             'HWP','LAW', 'law-business-license', 'E', 36, 'Y', 65, 'system'),
    ('LAW_SELF_TEST','자가품질검사관리',           'HWP','LAW', 'law-self-quality-test', 'M', 36, 'Y', 66, 'system'),
    ('LAW_CERT',     '수료증관리',                 'HWP','LAW', 'law-completion-cert', 'E', 36, 'Y', 67, 'system'),
...
INSERT INTO tbl_smart_diary_map (diary_no, tmpl_cd, match_level, impl_status, preferred_yn, ins_id) VALUES
    ('W0010','CCP_HEAT','FULL','GENERIC_CCP','N','system'), ('C0010','CCP_HEAT','FULL','GENERIC_CCP','Y','system'),
    ('W0020','CCP_COLD','FULL','DB_SCREEN','N','system'), ('C0020','CCP_COLD','FULL','DB_SCREEN','Y','system'),
    ('W0030','CCP_METAL','FULL','DB_SCREEN','N','system'), ('C0030','CCP_METAL','FULL','DB_SCREEN','Y','system'),
    ('W0040','CCP_WASH','FULL','GENERIC_CCP','N','system'), ('C0040','CCP_WASH','FULL','GENERIC_CCP','Y','system'),
    ('W0050','CCP_FILTER','FULL','GENERIC_CCP','N','system'), ('C0050','CCP_FILTER','FULL','GENERIC_CCP','Y','system'),
    ('W0060','CCP_SANITIZE','FULL','GENERIC_CCP','N','system'), ('C0060','CCP_SANITIZE','FULL','GENERIC_CCP','N','system'),
    ('W0061','CCP_SANITIZE','FULL','GENERIC_CCP','N','system'), ('C0061','CCP_SANITIZE','FULL','GENERIC_CCP','Y','system'),
    ...
    ('P0060','PEST','FULL','DB_SCREEN','Y','system'), ('P0070','WASTE','FULL','DB_SCREEN','Y','system'),
    ('P0080','WASH_EFFICACY','FULL','HWP','Y','system'), ('P0090','CROSS_CONTAM','FULL','HWP','Y','system'),
    ('P0180','SUPPLIER_EVAL','PARTIAL','CATALOG','Y','system'), ('P0190','RECALL','FULL','HWP','Y','system'),
    ('P0191','EMERGENCY','FULL','HWP','Y','system'), ('P0330','CCP_COLD','PARTIAL','DB_SCREEN','Y','system'),
    ('L0010','LAW_HEALTH','FULL','HWP','Y','system'), ('L0020','LAW_MATERIAL','PARTIAL','HWP','Y','system'),
    ('L0030','LAW_BUILDING','FULL','HWP','Y','system'), ('L0040','LAW_PRODUCTION','PARTIAL','HWP','Y','system'),
    ('L0050','LAW_LICENSE','FULL','HWP','Y','system'), ('L0060','LAW_SELF_TEST','PARTIAL','HWP','Y','system'),
    ('L0070','LAW_CERT','FULL','HWP','Y','system'), ('A0010','AUTO_COLD','PARTIAL','GENERIC_CCP','Y','system'),
