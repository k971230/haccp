...
VALUES
    ('health-cert-record', '건강진단관리기록부', 'WRK', 'LAW_HEALTH', 102, 'Y', 'system'),
    ('visitor-log', '입출입대장', 'WRK', NULL, 103, 'Y', 'system'),
    ('equipment-history', '설비이력기록부', 'WRK', 'EQUIP_CARD', 111, 'Y', 'system'),
    ('visual-insp-standard', '육안검사기준', 'WRK', NULL, 113, 'Y', 'system'),
    ('receiving-insp-hwp', '입고검사일지', 'WRK', 'RECV_INSP', 114, 'Y', 'system'),
    ('submaterial-recv-hwp', '부자재입고검수점검표', 'WRK', NULL, 115, 'Y', 'system'),
    ('calib-self-hwp', '자체검교정기록부', 'WRK', 'CALIB_LOG_TEMP', 116, 'Y', 'system'),
    ('calib-ext-hwp', '외부검교정기록부', 'WRK', NULL, 117, 'Y', 'system'),
    ('shipment-log-hwp', '제품출고관리일지', 'WRK', NULL, 118, 'Y', 'system'),
    ('waste-hwp', '폐기물처리점검표', 'WRK', 'WASTE', 119, 'Y', 'system'),
    ('inventory-hwp', '입출고및재고점검표', 'WRK', 'INV_CHECK', 120, 'Y', 'system'),
    ('edu-plan-hwp', '연간교육계획표', 'WRK', 'EDU_PLAN', 121, 'Y', 'system'),
    ('edu-log-hwp', '교육및회의결과보고서', 'WRK', 'EDU_LOG', 122, 'Y', 'system'),
    ('bad-product-hwp', '부적합품발생보고서', 'WRK', 'BAD_PRODUCT', 123, 'Y', 'system'),
    ('claim-hwp', '클레임및이물혼입보고서', 'WRK', 'CLAIM', 124, 'Y', 'system'),
    ('recall-hwp', '회수결과보고서', 'WRK', NULL, 125, 'Y', 'system'),
    ('eval-hwp', '실시상황평가표', 'WRK', NULL, 126, 'Y', 'system'),
    ('verify-ca-hwp', '검증개선조치보고서', 'WRK', 'VERIFY_CA', 127, 'Y', 'system'),
    ('handover-hwp', '업무인수인계서', 'WRK', 'HANDOVER', 128, 'Y', 'system'),
    ('process-hwp', '공정관리점검표', 'WRK', 'PROCESS', 129, 'Y', 'system'),
    ('vehicle-hwp', '차량운행일지', 'WRK', 'VEHICLE_LOG', 130, 'Y', 'system'),
    ('personal-hyg-hwp', '개인위생관리점검표', 'WRK', 'PERSONAL_HYG', 131, 'Y', 'system'),
    ('area-hyg-hwp', '작업장환경위생점검표', 'WRK', 'AREA_HYG', 132, 'Y', 'system'),
    ('water-hwp', '용수관리점검표', 'WRK', 'WATER', 133, 'Y', 'system'),
    ('verify-plan-hwp', '연간검증계획서', 'WRK', 'VERIFY_PLAN', 134, 'Y', 'system'),
    ('verify-check-hwp', '검증점검표', 'WRK', 'VERIFY_CHECK', 135, 'Y', 'system'),
    ('verify-report-hwp', '검증결과보고서', 'WRK', 'VERIFY_REPORT', 136, 'Y', 'system'),
    ('prod-test-hwp', '제품검사성적서', 'WRK', 'PROD_TEST', 137, 'Y', 'system'),
    ('surface-test-hwp', '표면오염도검사성적서', 'WRK', 'SURFACE_TEST', 138, 'Y', 'system')
...
UPDATE tbl_template SET mng_no = v.ha, upd_id = 'system', upd_dt = now()
  FROM (VALUES
    ('DAILY_HYG', 'HA-HYG-01'),
    ('LAW_HEALTH', 'HA-HYG-02'),
    ('PEST', 'HA-HYG-04'),
    ('PERSONAL_HYG', 'HA-HYG-05'),
    ('AREA_HYG', 'HA-HYG-06'),
    ('WATER', 'HA-HYG-07'),
    ('CCP_COLD', 'HA-CCP-05'),
    ('CCP_HEAT', 'HA-CCP-06-01'),
    ('CCP_SANITIZE', 'HA-CCP-06-02'),
    ('CCP_FILTER', 'HA-CCP-06-03'),
    ('CCP_METAL', 'HA-CCP-06-04'),
    ('CCP_VERIFY', 'HA-CCP-07'),
    ('EQUIP_CARD', 'HA-FAC-08'),
    ('FACILITY', 'HA-FAC-09'),
    ('CALIB_LOG_TEMP', 'HA-FAC-14'),
    ('CALIB_LOG_WGT', 'HA-FAC-14'),
    ('CALIB_LOG_SCL', 'HA-FAC-14'),
    ('WASTE', 'HA-FAC-18'),
    ('VEHICLE_LOG', 'HA-FAC-27'),
    ('RECV_INSP', 'HA-INV-11'),
    ('INV_CHECK', 'HA-INV-19'),
    ('EDU_PLAN', 'HA-EDU-18'),
    ('EDU_LOG', 'HA-EDU-19'),
    ('BAD_PRODUCT', 'HA-DOC-20'),
    ('CLAIM', 'HA-DOC-21'),
    ('VERIFY_CA', 'HA-VER-24'),
    ('HANDOVER', 'HA-DOC-25'),
    ('PROCESS', 'HA-PRC-26'),
    ('VERIFY_PLAN', 'HA-VER-04'),
    ('VERIFY_CHECK', 'HA-VER-05'),
    ('VERIFY_REPORT', 'HA-VER-06'),
    ('PROD_TEST', 'HA-VER-21'),
    ('SURFACE_TEST', 'HA-VER-22')
  ) AS v(tmpl_cd, ha)
