...
| `HF81` | 1 | `fe:pages/ccp/ColdMonitorPage.tsx` |
| `HF82` | 4 | `fe:api/documentApi.ts`<br>`fe:api/hygieneApi.ts`<br>`fe:hooks/useDocIdxQuery.ts`<br>`fe:lib/documentNav.ts` |
| `HF83` | 3 | `fe:pages/docs/documentbox/DocumentBoxPage.tsx`<br>`fe:pages/docs/documentbox/DocumentBoxRule.ts`<br>`fe:pages/hyg/HygieneCheckPage.tsx` |
| `HF84` | 6 | `fe:api/bizOpsApi.ts`<br>`fe:api/ccpFormsApi.ts`<br>`fe:api/masterApi.ts`<br>`fe:lib/rhwpStudio.ts`<br>`fe:pages/docs/hwpeditor/HwpDocumentEditorPage.tsx`<br>`fe:pages/docs/hwpeditor/HwpDocumentEditorRule.ts` |
| `HF85` | 3 | `fe:pages/bas/MasterDataPage.tsx`<br>`fe:pages/ccp/CcpFormPage.tsx`<br>`fe:pages/ops/BizOpsFormPage.tsx` |
| `HF86` | 2 | `fe:api/workflowApi.ts`<br>`fe:api/sys/approvalLineApi.ts` |
| `HF87` | 3 | `fe:api/taskWorkflowApi.ts`<br>`fe:pages/sys/approvalline/ApprovalLineManagementPage.tsx`<br>`fe:pages/sys/approvalline/ApprovalLineManagementRule.ts` |
| `HF88` | 1 | `fe:pages/tsk/TodayTasksPage.tsx` |
| `HF89` | 4 | `fe:pages/docs/corrective/CorrectiveActionManagementPage.tsx`<br>`fe:pages/docs/corrective/CorrectiveActionManagementRule.ts`<br>`fe:pages/docs/doccycle/ScheduleCycleManagementPage.tsx`<br>`fe:pages/docs/doccycle/ScheduleCycleManagementRule.ts` |
...
| `HF95` | 2 | `fe:components/layout/SearchArea.tsx`<br>`fe:pages/ccp/CcpGenericMonitorPage.tsx` |
| `HF96` | 1 | `fe:hooks/useGridAccess.ts` |
| `HF97` | 1 | `fe:shell/resolveDelete.ts` |
| `HF98` | 8 | `fe:pages/sys/auditlog/AuditLogRule.ts`<br>`fe:pages/sys/commoncode/CommonCodeRule.ts`<br>`fe:pages/sys/department/DepartmentManagementRule.ts`<br>`fe:pages/sys/loginhistory/LoginHistoryRule.ts`<br>`fe:pages/sys/menu/MenuManagementRule.ts`<br>`fe:pages/sys/role/RoleManagementRule.ts`<br>`fe:pages/sys/screenusage/ScreenUsageStatisticsRule.ts`<br>`fe:pages/sys/user/UserManagementRule.ts` |
| `HF99` | 15 | `fe:components/common/modal/CodeLookupModal.tsx`<br>`fe:components/common/modal/GlobalModal.tsx`<br>`fe:components/common/modal/modalTypes.ts`<br>`fe:components/common/modal/UserSignModal.tsx`<br>`fe:components/layout/LogPageShell.tsx`<br>`fe:lib/yn.ts`<br>`fe:pages/sys/auditlog/AuditLogPage.tsx`<br>`fe:pages/sys/commoncode/CommonCodePage.tsx`<br>`fe:pages/sys/department/DepartmentManagementPage.tsx`<br>`fe:pages/sys/loginhistory/LoginHistoryPage.tsx`<br>`fe:pages/sys/menu/MenuManagementPage.tsx`<br>`fe:pages/sys/role/RoleManagementPage.tsx`<br>`fe:pages/sys/screenusage/ScreenUsageStatisticsPage.tsx`<br>`fe:pages/sys/user/UserManagementPage.tsx`<br>`fe:stores/modalStore.ts` |
| `HF100` | 1 | `fe:pages/bas/MasterDataPage.rules.ts` |
...
| `HF122` | 4 | `fe:components/form/DocCell.tsx`<br>`fe:lib/docDateTime.ts`<br>`fe:pages/docs/legalupload/LegalDocumentUploadPage.tsx`<br>`fe:pages/docs/legalupload/LegalDocumentUploadRule.ts` |
| `HF123` | 7 | `fe:api/docs/hwpTemplateApi.ts`<br>`fe:components/form/DocFormMeta.tsx`<br>`fe:components/form/DocSummaryPanel.tsx`<br>`fe:components/ui/SysYnBadge.tsx`<br>`fe:pages/docs/hwptemplate/HwpTemplateFileHistModal.tsx`<br>`fe:pages/docs/hwptemplate/HwpTemplateManagementPage.tsx`<br>`fe:pages/docs/hwptemplate/HwpTemplateManagementRule.ts` |
...
| `HF125` | 3 | `fe:components/form/DocRowToolbar.tsx`<br>`fe:pages/bas/EquipmentHistoryPage.tsx`<br>`fe:pages/hyg/HealthCertPage.tsx` |
| `HF126` | 2 | `fe:api/pestDeviceHistApi.ts`<br>`fe:pages/bas/PestDeviceHistoryPage.tsx` |
...
| `HB60` | 1 | `be:ccp/dto/StorageRow.java` |
| `HB61` | 1 | `be:ccp/dto/CcpLimitRow.java` |
| `HB62` | 2 | `be:ccp/dto/ColdMonitorListRow.java`<br>`be:ccp/dto/DocCorrectiveDto.java` |
| `HB63` | 2 | `be:ccp/dto/ColdMonitorHeader.java`<br>`be:docs/corrective/DocCorrectiveMapper.java` |
| `HB64` | 3 | `be:ccp/dto/ColdMonitorTempCell.java`<br>`be:ccp/dto/ColdMonitorTempJoinRow.java`<br>`be:docs/corrective/DocCorrectiveSupport.java` |
| `HB65` | 1 | `be:ccp/dto/ColdMonitorRowDto.java` |
| `HB66` | 1 | `be:ccp/dto/ColdMonitorDetail.java` |
| `HB67` | 1 | `be:ccp/dto/ColdMonitorSaveRequest.java` |
| `HB68` | 1 | `be:ccp/dto/ColdMonitorDeleteItem.java` |
| `HB69` | 1 | `be:ccp/CcpColdMapper.java` |
| `HB70` | 2 | `be:ccp/CcpColdMapper.java`<br>`xml:ccp/CcpColdMapper.xml` |
| `HB71` | 1 | `be:ccp/CcpColdService.java` |
| `HB72` | 2 | `be:ccp/CcpColdController.java`<br>`be:docs/document/dto/DocumentApprovalRequest.java` |
| `HB73` | 1 | `be:bas/MasterType.java` |
| `HB74` | 1 | `be:bas/MasterService.java` |
| `HB75` | 2 | `be:bas/MasterMapper.java`<br>`xml:bas/MasterMapper.xml` |
| `HB76` | 1 | `be:bas/MasterController.java` |
...
| `HB83` | 5 | `be:docs/document/DocumentMapper.java`<br>`be:docs/document/dto/DocumentFileRow.java`<br>`be:hyg/dto/HygieneDeleteItem.java`<br>`be:hyg/dto/HygieneListRow.java`<br>`be:hyg/dto/HygieneSaveRequest.java` |
| `HB84` | 5 | `be:docs/document/DocumentMapper.java`<br>`be:hyg/HygieneMapper.java`<br>`be:hyg/dto/HygieneDeleteItem.java`<br>`be:hyg/dto/HygieneListRow.java`<br>`xml:docs/document/DocumentMapper.xml` |
| `HB85` | 2 | `be:docs/document/DocumentFileStorage.java`<br>`xml:hyg/HygieneMapper.xml` |
| `HB86` | 3 | `be:docs/document/DocumentService.java`<br>`be:docs/document/dto/HwpDocumentSaveRequest.java`<br>`be:hyg/HygieneService.java` |
| `HB87` | 2 | `be:docs/document/DocumentController.java`<br>`be:hyg/HygieneController.java` |
| `HB88` | 7 | `be:ccp/CcpFormsMapper.java`<br>`be:docs/document/dto/DocumentTemplateResponse.java`<br>`be:docs/document/dto/DocumentTemplateRow.java`<br>`be:docs/document/dto/HwpDocumentSaveRequest.java`<br>`be:ops/dto/BizOpsDeleteItem.java`<br>`be:ops/dto/BizOpsSaveRequest.java`<br>`be:workflow/WorkflowMapper.java` |
| `HB89` | 8 | `be:ccp/CcpFormsService.java`<br>`be:docs/template/TemplateFileNames.java`<br>`be:docs/template/TemplateFileStorage.java`<br>`be:docs/template/TemplateManifestEntry.java`<br>`be:ops/BizOpsMapper.java`<br>`xml:ops/BizOpsMapper.xml`<br>`xml:sys/approvalline/ApprovalLineMapper.xml`<br>`xml:workflow/WorkflowMapper.xml` |
| `HB90` | 6 | `be:ccp/CcpFormsController.java`<br>`be:docs/document/dto/DocumentTemplateResponse.java`<br>`be:docs/template/TemplateService.java`<br>`be:ops/BizOpsService.java`<br>`be:sys/approvalline/dto/ApprovalLineDeleteItem.java`<br>`be:workflow/dto/WorkflowDeleteItem.java` |
| `HB91` | 4 | `be:docs/template/TemplateController.java`<br>`be:ops/BizOpsController.java`<br>`be:sys/approvalline/ApprovalLineService.java`<br>`be:workflow/WorkflowService.java` |
| `HB92` | 24 | `be:docs/template/TemplateImportService.java`<br>`be:docs/template/TemplateManifestEntry.java`<br>`be:docs/template/TemplateManifestLoader.java`<br>`be:sys/SysPayload.java`<br>`be:sys/approvalline/ApprovalLineController.java`<br>`be:sys/approvalline/ApprovalLineMapper.java`<br>`be:sys/auditlog/AuditLogMapper.java`<br>`be:sys/auditlog/AuditWriter.java`<br>`be:sys/commoncode/CommonCodeMapper.java`<br>`be:sys/department/DepartmentMapper.java`<br>`be:sys/loginhistory/LoginHistoryMapper.java`<br>`be:sys/menu/MenuMgmtMapper.java`<br>`be:sys/role/RoleMgmtMapper.java`<br>`be:sys/screenusage/ScreenUsageMapper.java`<br>`be:sys/user/UserMapper.java`<br>`be:workflow/WorkflowController.java`<br>`xml:sys/auditlog/AuditLogMapper.xml`<br>`xml:sys/commoncode/CommonCodeMapper.xml`<br>`xml:sys/department/DepartmentMapper.xml`<br>`xml:sys/loginhistory/LoginHistoryMapper.xml`<br>`xml:sys/menu/MenuMgmtMapper.xml`<br>`xml:sys/role/RoleMgmtMapper.xml`<br>`xml:sys/screenusage/ScreenUsageMapper.xml`<br>`xml:sys/user/UserMapper.xml` |
| `HB93` | 10 | `be:docs/template/RhwpCliClient.java`<br>`be:sys/auditlog/AuditLogController.java`<br>`be:sys/commoncode/CommonCodeController.java`<br>`be:sys/department/DepartmentController.java`<br>`be:sys/loginhistory/LoginHistoryController.java`<br>`be:sys/menu/MenuMgmtController.java`<br>`be:sys/role/RoleMgmtController.java`<br>`be:sys/screenusage/ScreenUsageController.java`<br>`be:sys/user/UserController.java`<br>`be:tsk/TaskMapper.java` |
| `HB94` | 13 | `be:bas/EquipmentHistMapper.java`<br>`be:ccp/dto/GenericMonitorSaveRequest.java`<br>`be:hyg/dto/HealthCertDeleteItem.java`<br>`be:sys/auditlog/AuditLogService.java`<br>`be:sys/commoncode/CommonCodeService.java`<br>`be:sys/department/DepartmentService.java`<br>`be:sys/loginhistory/LoginHistoryService.java`<br>`be:sys/menu/MenuMgmtService.java`<br>`be:sys/role/RoleMgmtService.java`<br>`be:sys/screenusage/ScreenUsageService.java`<br>`be:sys/user/UserService.java`<br>`be:tsk/TaskService.java`<br>`xml:bas/EquipmentHistMapper.xml` |
| `HB95` | 5 | `be:bas/EquipmentHistService.java`<br>`be:ccp/CcpGenericMapper.java`<br>`be:hyg/HealthCertMapper.java`<br>`be:tsk/TaskController.java`<br>`xml:hyg/HealthCertMapper.xml` |
| `HB96` | 4 | `be:bas/EquipmentHistController.java`<br>`be:hyg/HealthCertService.java`<br>`be:tsk/DailyTaskGenerationJob.java`<br>`xml:ccp/CcpGenericMapper.xml` |
| `HB97` | 6 | `be:bas/dto/EquipmentHistDeleteItem.java`<br>`be:bas/dto/EquipmentHistSaveItem.java`<br>`be:bas/dto/PestDeviceHistDeleteItem.java`<br>`be:bas/dto/PestDeviceHistSaveItem.java`<br>`be:ccp/CcpGenericService.java`<br>`be:hyg/HealthCertController.java` |
| `HB98` | 4 | `be:bas/PestDeviceHistController.java`<br>`be:ccp/CcpGenericController.java`<br>`be:ccp/dto/GenericMonitorDeleteItem.java`<br>`be:docs/doccycle/CycleScheduleGenerator.java` |
| `HB99` | 7 | `be:bas/PestDeviceHistService.java`<br>`be:docs/doccycle/DocCycleController.java`<br>`be:docs/doccycle/DocCycleMapper.java`<br>`be:docs/doccycle/DocCycleService.java`<br>`be:docs/doccycle/DocumentAlarmScheduler.java`<br>`be:docs/doccycle/dto/DocCycleDeleteItem.java`<br>`xml:docs/doccycle/DocCycleMapper.xml` |
| `HB100` | 2 | `be:bas/PestDeviceHistMapper.java`<br>`xml:bas/PestDeviceHistMapper.xml` |
| `HB123` | 4 | `be:docs/hwptemplate/HwpTemplateController.java`<br>`be:docs/hwptemplate/HwpTemplateMapper.java`<br>`be:docs/hwptemplate/HwpTemplateService.java`<br>`xml:docs/hwptemplate/HwpTemplateMapper.xml` |
