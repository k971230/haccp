...
**주니어 첫 줄:** 루트 [`README.md`](../README.md) E2E → [`23_PIPELINE.md`](23_PIPELINE.md) (태그 색인) → [`15_HACCP_FE_BE_통합_상세스펙.md`](15_HACCP_FE_BE_통합_상세스펙.md) (유형별 이야기) → 도메인 README.

내부 번호 00~13은 옛 FE 세트 번호다. 파일명은 `1_`~`24_`이 정본이다. 혼동하면 아래 표를 본다.
...
| 22 | [`22_코드_케밥_양식매핑.md`](22_코드_케밥_양식매핑.md) | 코드 kebab·tmpl 매핑 |
| 23 | [`23_PIPELINE.md`](23_PIPELINE.md) | HF/HB 태그 색인. 업무 서사는 15 |
| 24 | [`24_URL_DB_폴더_패키지_정본.md`](24_URL_DB_폴더_패키지_정본.md) | URL=DB=폴더=패키지 경로 정본. 케밥·양식은 22 |
| 25 | [`25_CLAUDE_개발지침.md`](25_CLAUDE_개발지침.md) | 신규 화면·기능 작업 기준서. `.cursor` 규칙이 우선 |
