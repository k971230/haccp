...
| 06 | `feature/step-06-smoke-matrix` | 스모크 매트릭스 문서 (closes G-10·G-11) | - | 진행 중 |
...
| 16–19 | (ops) | 자격증명→서버→Jenkins→첫 배포 스모크 | - | 대기 — [`13_후속_STEP_16이후.md`](13_후속_STEP_16이후.md) |
...
| 구간 | STEP | 한 줄 |
|------|------|--------|
| 운영 마감 | 16→17→18→19 | 시크릿 → `/opt/haccp` → Jenkins → 첫 초록·수동 스모크 |
