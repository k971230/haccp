...
| STEP | 브랜치 | 내용 | 상태 |
|------|--------|------|------|
| 00 | `feature/step-00-branching-runbook` | 배포 런북·브랜치 규약 신설 | 진행 |
| 01 | `feature/step-01-remove-dead-ccp-apis` | dead FE API·config 제거 (G-13) | 진행 |

STEP 종료 시 이 표에 결과와 태그를 기록한다.
