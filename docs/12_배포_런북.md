...
| 17 | (ops) | 서버 `/home/ubuntu/haccp` 부트스트랩·migrate·스택 | - | 완료 (2026-08-11) — apache `:80` 점유로 edge `8080/8443` override |
| 18 | `feature/step-18-19-jenkins-prod-align` | Job `haccp-deploy`/`haccp-audit`, SMOKE/CORS/deploy override | `908e49b` | 완료 (2026-08-11) |
| 19 | (ops) | 첫 파이프라인 초록·수동 스모크 | - | 대기 — Docker Desktop(에이전트)·webhook 공개 URL |
| 20–28 | (잔여 G-ID) | G-14…G-21 등 | - | 대기 — 19 이후 · 동일 문서 |
