...
> 정본 교차: [`12_배포_런북.md`](12_배포_런북.md) §12–§15·§19 · [`frontend/haccp-web/docs/09_통합완성도_및_부족분.md`](../frontend/haccp-web/docs/09_통합완성도_및_부족분.md) · [`13_스모크_매트릭스.md`](../frontend/haccp-web/docs/13_스모크_매트릭스.md)
...
[작업 전 필독]
  - docs/12_배포_런북.md
  - docs/13_후속_STEP_16이후.md (본 문서)
  - frontend/haccp-web/docs/09_통합완성도_및_부족분.md
  - frontend/haccp-web/docs/13_스모크_매트릭스.md
[금지사항]
...
5. frontend/haccp-web/docs/13_스모크_매트릭스.md — 샘플 HWP 5종(07 §4.7 대표성) 전 컬럼
...
| 22 | G-20 | BE [`00_문서인덱스.md`](../backend/haccp-api/docs/00_문서인덱스.md) — FE 08/09/11·런북 미러 |

### STEP 23 완료 표기 (2026-08-11)

| 수용조건 | 판정 | 근거 |
|----------|------|------|
| 08 「API 잔존 · UI HWP」표 | OK | [`08` §5.7](../frontend/haccp-web/docs/08_HACCP_FE_BE_통합_상세스펙.md) |
| 07 갭/이관 교차 | OK | [`07` §6.4](../frontend/haccp-web/docs/07_메뉴_화면_API_DB_전수.md) ↔ §6.1·§4.7 |
...
| 2탭 검증 | OK | vitest `authCrossTab`·`authPaths` + 수동 절차 [`04` §5.1](../frontend/haccp-web/docs/04_인증_보안_JWT.md) |
| 09 G-22 | OK | 완료 · [`08` §3.4](../frontend/haccp-web/docs/08_HACCP_FE_BE_통합_상세스펙.md) |
...
| 편차 표 · 09 G-23 | OK | [`08` §3.5](../frontend/haccp-web/docs/08_HACCP_FE_BE_통합_상세스펙.md) · 스모크 §5.5 |
...
| 가이드 1절 | OK | [`11` §2.8](../frontend/haccp-web/docs/11_프레임워크_파일_보안_작성규칙.md) 등록·사용·실패 시 |
...
| 09 G-25 · 11 | OK | [`11` §2.9](../frontend/haccp-web/docs/11_프레임워크_파일_보안_작성규칙.md) · 코드 변경 없음 |
...
| main 배포에 무거운 E2E 미강제 | OK | `Jenkinsfile` 미변경 · 선택 `Jenkinsfile.e2e` |
| 시크릿 git 없음 | OK | `E2E_USER`/`E2E_PASS` env · `e2e/.env.example`만 |
| 09 G-21 | OK | 완료(최소) · [`13` §5.8](../frontend/haccp-web/docs/13_스모크_매트릭스.md) |
...
작업:
1. backend/haccp-api/docs/ 에 인덱스 절 또는 00 대칭 짧은 파일
...
작업 전 필독: FE 04 · shell auth · 50-operations OPS_AUTH_CROSSTAB(MES 규약 참고)
