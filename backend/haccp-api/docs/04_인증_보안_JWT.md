...
> FE 정본(파이프라인 표): [`frontend/haccp-web/docs/04_인증_보안_JWT.md`](../../../frontend/haccp-web/docs/04_인증_보안_JWT.md)  
> 파일 보안: FE [`11`](../../../frontend/haccp-web/docs/11_프레임워크_파일_보안_작성규칙.md)
