...
> 정본: `backend/haccp-api/docs/01_운영규칙.md`  
> FE 상세 정본: [`frontend/haccp-web/docs/01_운영규칙.md`](../../../frontend/haccp-web/docs/01_운영규칙.md)  
...
- 상세: FE [`11`](../../../frontend/haccp-web/docs/11_프레임워크_파일_보안_작성규칙.md)
