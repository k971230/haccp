...
- `ops/` — MyBatis XML — `ops` (운영·법적서류 등)
- `pref/` — MyBatis XML — `pref` (사용자 환경설정)
- `sys/` — MyBatis XML — `sys` (시스템 관리)
- `tsk/` — MyBatis XML — `tsk` (오늘 할 일·과제)
- `workflow/` — MyBatis XML — `workflow` (결재 워크플로)
