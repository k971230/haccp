...
import com.haccp.hwp.doccycle.DocCycleService;
...
public class DailyTaskGenerationJob {
    ...
    // 문서주기 예정일 생성 — 과제 생성보다 먼저 돌려 오늘 예정일이 빠지지 않게 한다
     ...
     * 일자: 2026-08-14
     * 코멘트:
     *   1) 매일 업무 시작 전에 문서주기 예정일을 채운 뒤 작성 과제·지연 알림을 생성한다
    ...
    public void generateDailyTasks() {
        docCycleService.regenerateAllCompanies();
