/**
 * UserController — 사용자 관리·서명 REST API (/api/v1/sys).
 *
 * 개발자: 박승우
 * 일자: 2026-08-12
 * 코멘트:
 *   1) 사용자 목록·저장·삭제는 /code/user-management, 서명은 /users 경로로 나뉘어 한 도메인 컨트롤러가 맡는다
 *   2) 회사코드는 JWT에서만 읽는다
...
// 역할 — 파일명 인코딩·화면 행·삭제키 목록
import java.nio.charset.StandardCharsets;
import java.util.List;
import java.util.Map;

/** 사용자 관리·서명 → /api/v1/sys/code/user-management/* · /api/v1/sys/users/* */
@RestController
...
public class UserController {
     ...
     */
    @GetMapping("/code/user-management/list")
     ...
     */
    @PutMapping("/code/user-management/save")
     ...
     */
    @PostMapping("/code/user-management/validate-delete")
     ...
     */
    @PostMapping("/code/user-management/delete")
