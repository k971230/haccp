/**
 * MenuMgmtController — 메뉴 관리 REST API (/api/v1/sys/menu-management).
 *
 * 개발자: 박승우
 * 일자: 2026-08-12
 * 코멘트:
...
/** 메뉴 관리 화면 → /api/v1/sys/menu-management/* */
@RestController
@RequestMapping("/api/v1/sys/menu-management")
