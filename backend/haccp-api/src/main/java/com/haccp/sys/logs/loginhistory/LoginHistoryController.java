/**
 * LoginHistoryController — 로그인 이력 REST API (/api/v1/sys/logs/login-history).
 *
 * 개발자: 박승우
 * 일자: 2026-08-12
 * 코멘트:
...
/** 로그인 이력 화면 → /api/v1/sys/logs/login-history/* */
@RestController
@RequestMapping("/api/v1/sys/logs/login-history")
