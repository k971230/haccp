# com.haccp.sys.commoncode — 공통코드 관리

화면코드 `common-code-management` · XML `resources/mapper/sys/commoncode/CommonCodeMapper.xml` · SP `db_sasshaccp/72_migrate_sp_common_code_v2.sql`
