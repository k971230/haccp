/**
 * ScreenUsageController — 화면 이용 통계 REST API (/api/v1/sys/logs/screen-usage-statistics).
 *
 * 개발자: 박승우
 * 일자: 2026-08-12
 * 코멘트:
...
/** 화면 이용 통계 화면 → /api/v1/sys/logs/screen-usage-statistics/* */
@RestController
@RequestMapping("/api/v1/sys/logs/screen-usage-statistics")
