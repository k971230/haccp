/**
 * HygProcessDraftController — 위생공정 양식 작성 REST.
 *
 * 개발자: 박승우
 * 일자: 2026-08-24
 * 코멘트:
 *   1) 경로 /api/v1/draft/hyg/hyg-process — FE SCREEN_PATH 와 같은 칸. 회사코드는 JWT 만
 *   2) 양식·목록·상세 GET, 저장 PUT, 삭제 POST 2단계
 *   3) 전송·전송취소는 이 컨트롤러가 아니라 문서 허브 /api/v1/docs/documents/approval 을 쓴다
 *
 * PIPELINE[HB136] 위생공정 작성 Controller
 */
...
@RestController
@RequestMapping("/api/v1/draft/hyg/hyg-process")
@RequiredArgsConstructor
public class HygProcessDraftController {
    private final HygProcessDraftService service;
