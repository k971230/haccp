/**
 * HygProcessDraftListRow — 위생공정 작성 좌측 목록 1행.
 *
 * 개발자: 박승우
 * 일자: 2026-08-24
 * 코멘트:
 *   1) SP 컬럼은 snake, 앱은 camelCase (map-underscore-to-camel-case)
 *   2) 좌측 그리드 표시는 일자·양식코드·양식명·작성자·결재여부다
 *   3) 결재여부 3단계(전송대기/전송/결재완료) 묶음은 화면이 status 로 계산한다
 *
...
@Data
public class HygProcessDraftListRow {
    // tbl_document.idx — 그리드 행 키
    private Long docIdx;
    // tbl_hyg_process.idx
    private Long hdrIdx;
    // 양식코드 — 좌측 버튼. 클릭하면 우측 지면이 이 양식으로 열린다
