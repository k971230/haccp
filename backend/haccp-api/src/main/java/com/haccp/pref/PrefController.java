 ...
 * 일자: 2026-09-07
 * 코멘트:
 *   1) GET /list — 화면 진입 시 그 화면의 그리드 설정 전체를 목록으로 받는다. Mapper 직행
 *   2) PUT /save — 열 너비·표시여부 변경을 업서트한다. prefJson이 비면 초기화. PrefService
...
public class PrefController {
    ...
    // 그리드 설정 조회 — 패스스루. 트랜잭션·검증이 없어 Mapper 직행
    private final PrefMapper prefMapper;
    // 그리드 설정 저장 — CUD 경계. @Transactional 은 PrefService
