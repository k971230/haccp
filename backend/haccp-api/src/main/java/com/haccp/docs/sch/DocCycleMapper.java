...
public interface DocCycleMapper {
     ...
     * 일자: 2026-08-14
     * 코멘트:
     *   1) 선택 양식의 주기 1건 + 반복 상세(details jsonb) + 사용양식 결재선을 조회한다
    ...
    void saveCycle(
            // JWT 회사코드
            @Param("coCd") String coCd,
            // camelCase JSON 폼 1건 — tmplCd·baseDt·cycleCd·nonworkRule·dueTime·deptCd·userId·useYn·apprLineCd·details[]
     ...
     * 일자: 2026-09-08
     * 코멘트:
     *   1) 삭제하면 안 되는 첫 주기 1건을 돌려준다 — 진행·완료 과제
