 ...
 * 일자: 2026-08-20
 * 코멘트:
 *   1) 저장은 tbl_tml_ccp_chk_ver. 공정점검은 HtmlTemplateMapper
 *   2) 회사코드는 JWT coCd만 넘긴다
 *   3) 삭제는 blocker 후 d_000
 *
 * PIPELINE[HB131] CCP 검증점검 양식 Mapper
 */
package com.haccp.docs.html.ccpverifytemplate;
...
public interface CcpVerifyTemplateMapper {
     ...
     * 일자: 2026-08-20
     * 코멘트:
     *   1) 양식 항목을 반환한다. tml_ccp_chk_000 이면 시드
     *   2) 우측 A4가 호출한다
     *   3) 없으면 빈 목록
     */
     ...
     * 일자: 2026-08-20
     * 코멘트:
     *   1) 표준 시드를 복사해 tml_ccp_chk_NNN 1건을 만든다
