...
| html/ccpverifytemplate | 중요관리점(CCP) 검증점검표 양식관리 (`tbl_tml_ccp_chk_ver`) |
| html/ccppkgtemplate | 중요관리점(CCP-1B) 모니터링일지 양식관리 (`tbl_tml_ccp_pkg_ver`) |
| html/ccphtgtemplate | 중요관리점(CCP-2B) 모니터링일지 양식관리 (`tbl_tml_ccp_htg_ver`) |
