/**
 * CcpHtgTemplateMapper — CCP-2B 가열 모니터링일지 양식 SP.
 *
 * 개발자: 박승우
 * 일자: 2026-08-20
 * 코멘트:
 *   1) 저장은 tbl_html_ccp_htg_ver. 검증점검은 CcpVerifyTemplateMapper
 *   2) 회사코드는 JWT coCd만 넘긴다
 *   3) 삭제는 blocker 후 d_000
 *
 * PIPELINE[HB133] CCP-2B 가열일지 양식 Mapper
 */
package com.haccp.docs.htmlform.ccphtgtemplate;
...
@Mapper
public interface CcpHtgTemplateMapper {
     ...
     * 일자: 2026-08-20
     * 코멘트:
     *   1) 양식 항목을 반환한다. html_ccp_htg_000 이면 시드
     *   2) 우측 A4가 호출한다
     *   3) 없으면 빈 목록
     */
     ...
     * 일자: 2026-08-20
     * 코멘트:
     *   1) 표준 시드를 복사해 html_ccp_htg_NNN 1건을 만든다
