/**
 * CcpPkgTemplateMapper — CCP-1B 포장 모니터링일지 양식 SP.
 *
 * 개발자: 박승우
 * 일자: 2026-08-20
 * 코멘트:
 ...
 *
 * PIPELINE[HB132] CCP-1B 포장일지 양식 Mapper
 */
package com.haccp.docs.htmlform.ccppkgtemplate;
...
@Mapper
public interface CcpPkgTemplateMapper {
