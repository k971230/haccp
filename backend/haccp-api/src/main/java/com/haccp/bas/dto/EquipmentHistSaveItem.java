/**
 * EquipmentHistSaveItem — 설비 이력 저장 행.
 *
 * 개발자: 박승우
 * 일자: 2026-08-07
 * 코멘트:
 *   1) idx·equipIdx와 이력 필드를 camelCase JSON 행으로 수집한다
...
/** 설비 이력 저장 행 — SP camelCase payload와 1:1이다. */
@Data
public class EquipmentHistSaveItem {
    // 수정 대상 대리키 — null이면 신규 행
    private Long idx;
    // 상위 설비 대리키 — 저장 SP 필수
    private Long equipIdx;
