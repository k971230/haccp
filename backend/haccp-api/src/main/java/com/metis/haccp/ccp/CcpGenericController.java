 ...
 * 일자: 2026-08-06
 * 코멘트:
 *   1) /api/v1/ccp/generic-monitor 경로에서 템플릿·상세·저장·삭제를 제공한다
...
import com.metis.haccp.ccp.dto.GenericMonitorDeleteItem;
import com.metis.haccp.ccp.dto.GenericMonitorSaveRequest;
...
@RestController
@RequestMapping("/api/v1/ccp/generic-monitor")
