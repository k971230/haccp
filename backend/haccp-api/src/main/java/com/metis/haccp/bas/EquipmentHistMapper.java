/**
 * EquipmentHistMapper — 설비 이력 MyBatis 매퍼.
 *
 * 개발자: 박승우
 * 일자: 2026-08-07
 * 코멘트:
...
@Mapper
public interface EquipmentHistMapper {
    ...
    void save(
            // JWT 회사코드
            @Param("coCd") String coCd,
            // camelCase JSON 행 — idx·equipIdx·histDt 등
