...
// 역할 — 결재·삭제 요청 DTO
import com.metis.haccp.doc.dto.DocumentApprovalRequest;
import com.metis.haccp.doc.dto.DocumentDeleteItem;
import com.metis.haccp.doc.dto.HwpDocumentSaveRequest;
// 역할 — HTTP 요청 원천
...
public class DocumentController {
    ...
    public ResponseEntity<FileSystemResource> download(
        ...
        try {
            ...
            throw new com.metis.haccp.common.exception.BizException("파일을 읽지 못했습니다.");
        }
    }
