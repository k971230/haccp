 ...
 *   3) 새 공통 모달은 modalTypes.ModalPropsMap 추가 후 여기 분기 한 줄만 늘리면 된다. ReasonAction 이 그 예다
 *
...
// 역할 — 모달 종류별 props 계약
import type { CodeLookupModalProps, ReasonActionModalProps, UserSignModalProps } from "./modalTypes";
// 역할 — 코드 선택 팝업
...
export function GlobalModal() {
  ...
  switch (modalType) {
    ...
    case "ReasonAction":
      return <ReasonActionModal {...(modalProps as ReasonActionModalProps)} />;
    default:
      return null;
  }
}
