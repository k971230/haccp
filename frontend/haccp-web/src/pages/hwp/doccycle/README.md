...
| 동작 | API (`api/hwp/docCycleApi.ts`) | SP | 테이블 |
|---|---|---|---|
| 양식 목록 | `listDocCycleForms` | `sp_schedule_cycle_management_form_r_000` | `tbl_company_template` `tbl_template` `tbl_schedule_rule` |
| 단건 | `getDocCycle` | `sp_schedule_cycle_management_r_000` | `tbl_schedule_rule` `tbl_schedule_rule_detail` |
| 저장 | `saveDocCycle` | `sp_schedule_cycle_management_c_000` | `tbl_schedule_rule` `tbl_schedule_rule_detail` |
