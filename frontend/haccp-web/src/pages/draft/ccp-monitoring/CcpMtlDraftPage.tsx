/**
 * CcpMtlDraftPage — CCP 금속검출 모니터링일지 작성.
 *
 * 개발자: 박승우
 * 일자: 2026-08-24
 * 코멘트:
...
// 역할 — 이 화면 작성 API
import { ccpMtlDraftApi } from "@/api/draft/ccpMonitoringDraftApi";
// 역할 — 이 화면 상수
import { PAPER_SUBTITLE, PAPER_TITLE, PERSIST_ID, SCRN_CD, SPLIT_KEY } from "./CcpMtlDraftRule";
 ...
 */
export function CcpMtlDraftPage() {
  return (
    <HtmlFormDraftPage
      ...
      // 작성 API — /api/v1/draft/ccp-monitoring/ccp-mtl
      api={ccpMtlDraftApi}
    />
  );
}
