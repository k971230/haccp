/**
 * CcpHtgDraftPage — CCP 가열 모니터링일지 작성.
 *
 * 개발자: 박승우
 * 일자: 2026-08-24
 * 코멘트:
 ...
 *
 * PIPELINE[HF179] CCP 가열 작성 화면
 */
// 역할 — CCP 가열 지면 — 양식관리와 같은 HTML
import { CcpHtgPaper } from "@/pages/docs/html-form/ccphtgtemplate/CcpHtgPaper";
// 역할 — 양식 작성 공통 화면
import { HtmlFormDraftPage } from "../HtmlFormDraftPage";
// 역할 — 이 화면 작성 API
import { ccpHtgDraftApi } from "@/api/draft/ccpMonitoringDraftApi";
// 역할 — 이 화면 상수
import { PAPER_SUBTITLE, PAPER_TITLE, PERSIST_ID, SCRN_CD, SPLIT_KEY } from "./CcpHtgDraftRule";
 ...
 */
export function CcpHtgDraftPage() {
  return (
    <HtmlFormDraftPage
      ...
      // 작성 API — /api/v1/draft/ccp-monitoring/ccp-htg
      api={ccpHtgDraftApi}
    />
  );
}
