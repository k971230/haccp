 ...
 *   2) 예시 tml_ccp_pkg_000. 저장본은 tml_ccp_pkg_001부터 SP가 채번한다
 *   3) persist·scrnCd 값을 폴더 이동 후에도 바꾸지 않는다
 *
 * PIPELINE[HF132] CCP-1B 포장일지 양식 규칙
 */
import { TML_CCP_PKG_000 } from "@/api/docs/htmlFormApi";
...
/** 화면 예시 양식코드 — 시드 항목은 tml_ccp_pkg_000 */
export const STD_TMPL_CD = TML_CCP_PKG_000;

/** 자사 양식 접두 */
export const USR_TMPL_PREFIX = "tml_ccp_pkg_" as const;
 ...
 * 일자: 2026-08-20
 * 코멘트:
 *   1) 다음 자사 양식코드를 제안한다 — tml_ccp_pkg_001 …
