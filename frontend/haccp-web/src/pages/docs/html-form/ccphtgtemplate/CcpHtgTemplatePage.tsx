/**
 * CcpHtgTemplatePage — 중요관리점(CCP-2B) 모니터링일지 양식관리.
 *
 * 개발자: 박승우
 * 일자: 2026-08-20
 * 코멘트:
 ...
 */
import { CcpHtgPaper } from "./CcpHtgPaper";
...
import {
  ...
  STD_TMPL_CD,
  nextCcpHtgTmplCd,
} from "./CcpHtgTemplateRule";

/**
 * 개발자: 박승우
 * 일자: 2026-08-20
 * 코멘트:
 *   1) HTML양식 원본 하위 CCP-2B 가열일지 메뉴에서 연다
 *   2) 공정점검·검증점검·포장일지와 같은 좌우 분할·저장 흐름이다
 *   3) scrnCd는 폴더를 옮겨도 바꾸지 않는다
 */
export default function CcpHtgTemplatePage() {
  return (
