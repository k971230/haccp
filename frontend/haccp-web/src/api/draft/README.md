...
| `hygProcessDraftApi.ts` | `hyg-process` | `apiOf("hyg-process")` = `/api/v1/draft/html/hyg-process` |
| `ccpVerifyDraftApi.ts` | `ccp-verify` | `apiOf("ccp-verify")` = `/api/v1/draft/html/ccp-verify` |
