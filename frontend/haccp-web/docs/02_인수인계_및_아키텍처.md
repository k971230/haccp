...
> 정본: `frontend/haccp-web/docs/02_인수인계_및_아키텍처.md`  
...
> BE 대칭: [`backend/haccp-api/docs/02_인수인계_및_아키텍처.md`](../../../backend/haccp-api/docs/02_인수인계_및_아키텍처.md)  
> 파일 지도: [`10`](10_파일구조_컴포넌트_함수지도.md) · 작성 체크: [`11`](11_프레임워크_파일_보안_작성규칙.md)
...
- 잔존 `ccpMetalApi` / `ccpVerificationApi` 신규 import 금지
...
상세 트리·export: [`10`](10_파일구조_컴포넌트_함수지도.md)
...
- **예외 커밋 대상:** `frontend/haccp-web/docs/` · `backend/haccp-api/docs/` · `db_sasshaccp/`
