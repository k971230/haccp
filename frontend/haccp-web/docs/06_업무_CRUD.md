...
| 주제 | 정본 |
|------|------|
| 완성도 판정 · P0/P1 · G-xx 상태 | **[`09_통합완성도_및_부족분.md`](09_통합완성도_및_부족분.md)** |
| 메뉴×FE×BE×API | [`07`](07_메뉴_화면_API_DB_전수.md) |
| URL·Job·파이프라인 | [`08`](08_HACCP_FE_BE_통합_상세스펙.md) |
...
→ **[`09_통합완성도_및_부족분.md`](09_통합완성도_및_부족분.md)**  
스모크 표 → [`13_스모크_매트릭스.md`](13_스모크_매트릭스.md)
