...
| G-21 | ~~E2E/자동화 테스트~~ | 핵심 루프 자동 테스트 부재 | **완료(최소)** — 2026-08-11 STEP 28. Playwright `e2e/cold-request.spec.ts`: (1)로그인→냉장→목록 (2)write 시 신규·상신. `npm run test:e2e` · env 시크릿. **main Jenkins 미포함** · `Jenkinsfile.e2e` |
