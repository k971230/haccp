...
> 정본: `frontend/haccp-web/docs/04_인증_보안_JWT.md`  
> 작성일: 2026-08-10 · 개발자: 박승우  
> BE 대칭: [`backend/haccp-api/docs/04_인증_보안_JWT.md`](../../../backend/haccp-api/docs/04_인증_보안_JWT.md)  
> 파일 path traversal·볼륨: [`11`](11_프레임워크_파일_보안_작성규칙.md) §2~3
...
| CORS | `CORS_ALLOWED_ORIGINS` (로컬 `http://localhost:5174`) · credentials false |
...
| 서명 등록·클립보드·실패 시 (G-24) | **[`11` §2.8](11_프레임워크_파일_보안_작성규칙.md)** |
